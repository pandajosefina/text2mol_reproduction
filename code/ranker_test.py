...
parser.add_argument('test_dir', metavar='directory', type=str, nargs=1,
                    help='directory where test embeddings are located')
...
cids_test = np.load(osp.join(test_dir, "cids_test.npy"), allow_pickle=True)
...
text_embeddings_test = np.load(osp.join(test_dir, "text_embeddings_test.npy"))
...
chem_embeddings_test = np.load(osp.join(test_dir, "chem_embeddings_test.npy"))
